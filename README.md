...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w7nftyo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w7nftyo.containers.anotherwebservice.com/
...
```
git clone git@github.com:gdoroja/container-w7nftyo.git
cd container-w7nftyo
```
...
```
docker attach container-w7nftyo
```
